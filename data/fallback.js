window.ISAAC_FALLBACK = {
  "items": [
    ...
    },
    {
      "id": "270",
      "name": "Leech",
      "description": "Spawns a familiar leech on the ground that hunts down enemies and heals you for half a heart each time it eats one The Leech deals 1.5 contact damage per tick",
      "quality": 2,
      "pool": "treasure",
      "quote": "Blood sucker",
      "type": "Passive, Familiar",
    ...
    },
    {
      "id": "271",
      "name": "Mystery Sack",
      "description": "A bag that follows Isaac and drops a random heart, coin, bomb or key every 5-6 rooms (alternating, 5 rooms then 6, then repeats) Can drop any kind of heart, coin, bomb or key",
      "quality": 2,
      "pool": "secret",
      "quote": "?",
      "type": "Passive, Familiar",
    ...
    },
    {
      "id": "356",
      "name": "Car Battery",
      "description": "The Car Battery causes your spacebar item to activate twice on each use For example, with Yum Heart you would heal 2 full red hearts instead of 1",
      "quality": 3,
      "pool": "shop",
      "quote": "Double charge!",
      "type": "Passive",
    ...
    },
    {
      "id": "410",
      "name": "Evil Eye",
      "description": "While firing tears this item gives you a chance to fire an eye across the screen with a very slow shot speed, which will fire tears of its own in the same direction as Isaac The evil eye shots will be destroyed if they come into contact with enemies or obstacles",
      "quality": 2,
      "pool": "treasure",
      "quote": "Eye shot!",
      "type": "Passive",
    ...
    },
    {
      "id": "426",
      "name": "Obsessed Fan",
      "description": "A purple familiar fly that follows your exact movement on a 1 second delay and deals 2 contact damage to enemies Counts as 1 of 3 fly items needed towards the Beelzebub transformation",
      "quality": 0,
      "pool": "treasure",
    ...
    },
    {
      "id": "436",
      "name": "Milk!",
      "description": "Gives Isaac a familiar glass of milk that follows him and spills on the floor upon taking damage After being spilt, the milk gives you a -2 Tear Delay (Tears up) for the rest of the room",
      "quality": 1,
      "pool": "treasure",
    ...
    },
    {
      "id": "440",
      "name": "Kidney Stone",
      "description": "Randomly while firing tears, Isaac will stop firing and turn red, where he will charge and release a lot of 'tears' in one go. In the burst of tears is a kidney stone which deals a lot of damage REPENTANCE - Kidney Stone is no longer a speed downgrade",
      "quality": 2,
      "pool": "treasure",
    ...
    },
    {
      "id": "446",
      "name": "Dead Tooth",
      "description": "While firing, you gain a green aura that poisons any enemies which touch it. The poison deals your tear damage per tick, for 2 ticks Has no effect on Lilith, as she cannot fire tears",
      "quality": 1,
      "pool": "treasure",
      "quote": "Halitosis",
      "type": "Passive",
    ...
    },
    {
      "id": "454",
      "name": "Polydactyly",
      "description": "Allows Isaac to carry two cards, runes or pills (or any combination of these) at the same time Drops a random card, pill or rune on pickup",
      "quality": 2,
      "pool": "treasure",
      "quote": "Hold me!",
      "type": "Passive",
    ...
    },
    {
      ...
      "description": "+0.38 Range Up Drops a lucky penny",
      "quality": 1,
      "pool": "boss",
    ...
    },
    {
      "id": "468",
      "name": "Shade",
      "description": "Isaac gains a shadow familiar that will follow Isaac's movement pattern by a 0.66 second delay and deal 5 contact damage to enemies per tick Shade is absorbed by Isaac after dealing over 666 damage. This spawns friendly charger enemies and causes Isaac to deal 5 contact damage (same as the shade did). This effect stacks with multiple shades, scaling the contact damage each time",
      "quality": 0,
      "pool": "devil",
      "quote": "It follows",
      "type": "Passive, Familiar",
    ...
    },
    {
      "id": "469",
      "name": "Depression",
      "description": "Isaac gains a cloud familiar that follows him and leaves a trail of tears on the floor which damages enemies for 2 damage per tick Enemies touching the cloud have a chance to activate the Crack the Sky effect, which spawns a light beam that deals damage equal to your tear damage + 20",
      "quality": 1,
      "pool": "treasure",
      "quote": ":(",
      "type": "Passive, Familiar",
    ...
    },
    {
      "id": "471",
      "name": "Lil Monstro",
      "description": "Gives Isaac a small Monstro familar, who's tears can be charged and released in a shotgun style effect, much like Monstro's main attack Lil Monstro's tears each deal base damage (3.5) and do not scale with damage upgrades",
      "quality": 2,
      "pool": "treasure",
      "quote": "Ain't he cute?",
      "type": "Passive, Familiar",
    ...
    },
    {
      "id": "544",
      "name": "Pointy Rib",
      "description": "A familiar that can be aimed with the fire buttons similar to the Finger item, dealing contact damage to enemies equal to your tear damage Added as part of the Afterbirth+ Booster Pack #5",
      "quality": 2,
      "pool": "treasure",
      "quote": "Stabbing time",
      "type": "Passive",
    ...
    },
    {
      "id": "637",
      "name": "Knockout Drops",
      "description": "Isaac now has a chance to fire a fist instead of normal tears, which have a much higher knockback effect and confuse enemies for a few seconds Enemies that are knocked back will take 10 damage and knock back any enemy they are knocked into, dealing damage to them as well",
      "quality": 3,
      "pool": "treasure",
    ...
    },
    {
      ...
      "description": "When picked up, this item gives you a stat increase, based on which is currently the lowest. Stat options are: +1.0 Damage, +0.6 Tears, +0.2 Speed, +5.25 Range Also drops either a bomb, a key or 3 coins on the ground. This is decided by whatever you have the least of. Keys and bombs are equal to 3 coins for deciding which to give",
      "quality": 1,
      "pool": "boss",
  ...
  "paths": [
    {
      "id": "beast",
      "name": "The Beast",
      "description": "Full path to The Beast (Dogma + Beast fight)",
      "steps": [
        {
          "id": "s1",
          "label": "Defeat Mom (Foot)"
        },
        {
          "id": "s2",
          "label": "Get the Negative or Polaroid"
        },
        {
          "id": "s3",
          "label": "Defeat Mom's Heart / It Lives (11 times to unlock door)"
        },
        {
          "id": "s4",
          "label": "Go to Mausoleum (use knife pieces or Dad's Note)"
        },
        {
          "id": "s5",
          "label": "Defeat Mom (Mausoleum)"
        },
        {
          "id": "s6",
          "label": "Enter the crack to Gehenna II"
        },
        {
          "id": "s7",
          "label": "Defeat the four Horsemen (Famine, Pestilence, War, Death)"
        },
        {
          "id": "s8",
          "label": "Pick up Dad's Note"
        },
        {
          "id": "s9",
          "label": "Go to Home"
        ...
        {
          "id": "s10",
          "label": "Defeat Dogma, then The Beast"
        }
      ]
    },
    {
      "id": "mega-satan",
      "name": "Mega Satan",
      "description": "Path to Mega Satan (two key pieces)",
      "steps": [
        {
          "id": "s1",
          "label": "Defeat Mom's Heart / It Lives"
        },
        {
          "id": "s2",
          "label": "Get Angel Room (skip first Devil Deal or use sacrifice)"
        },
        {
          "id": "s3",
          "label": "Fight and defeat Angel for Key Piece 1"
        },
        {
          "id": "s4",
          "label": "Get second Angel Room (next floor or sacrifice)"
        },
        {
          "id": "s5",
          "label": "Fight and defeat Angel for Key Piece 2"
        },
        {
          "id": "s6",
          "label": "Reach The Chest or Dark Room"
        },
        {
          "id": "s7",
          "label": "Use both key pieces on the large golden door"
        },
        {
          "id": "s8",
          "label": "Defeat Mega Satan"
        }
      ]
    },
    {
      "id": "mother",
      "name": "Mother",
      "description": "Path to Mother (Alt path)",
      "steps": [
        {
          "id": "s1",
          "label": "Defeat Mom (Foot)"
        ...
        {
          "id": "s2",
          "label": "Go to Downpour II (alt path)"
        },
        {
          "id": "s3",
          "label": "Get the knife piece in the mirror world"
        },
        {
          "id": "s4",
          "label": "Continue alt path through Mines II, Mausoleum II"
        },
        {
          "id": "s5",
          "label": "Defeat Mom (Mausoleum) for second knife piece"
        },
        {
          "id": "s6",
          "label": "Assemble the knife"
        },
        {
          "id": "s7",
          "label": "Go to Corpse II"
        },
        {
          "id": "s8",
          "label": "Use knife on the flesh door"
        },
        {
          "id": "s9",
          "label": "Defeat Mother"
    ...
    },
    {
      "id": "hush",
      "name": "Hush",
      "description": "Path to Hush (Blue Womb)",
      "steps": [
        {
          "id": "s1",
          "label": "Defeat Mom's Heart / It Lives at least once (unlocks Blue Womb)"
        },
        {
          "id": "s2",
          "label": "In a single run, defeat It Lives within 30 minutes"
        },
        {
          "id": "s3",
          "label": "A trapdoor appears; enter to go to Blue Womb"
        },
        {
          "id": "s4",
          "label": "Clear Blue Womb I (two rooms)"
        },
        {
          "id": "s5",
          "label": "Enter the boss room and defeat Hush"
        }
      ]
    },
    {
      "id": "delirium",
      "name": "Delirium",
      "description": "Path to Delirium (Void)",
      "steps": [
        {
          "id": "s1",
          "label": "Unlock the Void (defeat Hush once)"
        },
        {
          "id": "s2",
          "label": "After defeating Hush, a portal to the Void can appear"
        },
        {
          "id": "s3",
          "label": "Or: portal can appear after Mega Satan, Boss Rush, or Mom"
        },
        {
          "id": "s4",
          "label": "Enter the Void portal"
        },
        {
          "id": "s5",
          "label": "Navigate the Void (find the boss room)"
        },
        {
          "id": "s6",
          "label": "Defeat Delirium"
        }
      ]
    },
    {
      "id": "corpse",
      "name": "Corpse",
      "description": "Path to Corpse (alt path floors)",
      "steps": [
        {
          "id": "s1",
          "label": "Defeat Mom (Foot)"
        ...
        {
          "id": "s2",
          "label": "Go to Downpour II via alt path"
        },
        {
          "id": "s3",
          "label": "Get first knife piece in mirror world (Downpour II)"
        },
        {
          "id": "s4",
          "label": "Continue to Mines II, get second knife piece (Mausoleum Mom)"
        },
        {
          "id": "s5",
          "label": "Assemble the knife"
        ...
        {
          "id": "s6",
          "label": "Go to Mausoleum II and use knife on the flesh door"
        },
        {
          "id": "s7",
          "label": "Enter Corpse I"
        },
        {
          "id": "s8",
          "label": "Clear Corpse I and go to Corpse II"
        },
        {
          "id": "s9",
          "label": "Optional: defeat Mother at end of Corpse II"
        }
      ]
    },
    {
      "id": "lamb",
      "name": "The Lamb",
      "description": "Path to The Lamb (Dark Room)",
      "steps": [
        {
          "id": "s1",
          "label": "Defeat Mom's Heart / It Lives"
        ...
        {
          "id": "s2",
          "label": "Take the Negative (not the Polaroid)"
        },
        {
          "id": "s3",
          "label": "Go to Sheol via the trapdoor"
        },
        {
          "id": "s4",
          "label": "Defeat Satan in Sheol"
        },
        {
          "id": "s5",
          "label": "The Negative activates — enter the chest to go to Dark Room"
        },
        {
          "id": "s6",
          "label": "Navigate Dark Room to the boss room"
        },
        {
          "id": "s7",
          "label": "Defeat The Lamb"
        }
      ]
    },
    {
      "id": "chest",
      "name": "??? (Chest)",
      "description": "Path to ??? in The Chest",
      "steps": [
        {
          "id": "s1",
          "label": "Defeat Mom's Heart / It Lives"
        ...
        {
          "id": "s2",
          "label": "Take the Polaroid (not the Negative)"
        },
        {
          "id": "s3",
          "label": "After It Lives, go to Cathedral (beam of light)"
        },
        {
          "id": "s4",
          "label": "Defeat Isaac in Cathedral"
        },
        {
          "id": "s5",
          "label": "Enter the golden gate to The Chest"
        },
        {
          "id": "s6",
          "label": "Defeat ??? (Blue Baby)"
        }
      ]
    },
    {
      "id": "isaac",
      "name": "Isaac (Cathedral)",
      "description": "Path to Isaac in Cathedral",
      "steps": [
        {
          "id": "s1",
          "label": "Defeat Mom's Heart / It Lives"
        ...
        {
          "id": "s2",
          "label": "Take the Polaroid"
        },
        {
          "id": "s3",
          "label": "Go to Cathedral via the beam of light"
        },
        {
          "id": "s4",
          "label": "Defeat Isaac"
    ...
    },
    {
      "id": "satan",
      "name": "Satan (Sheol)",
      "description": "Path to Satan in Sheol",
      "steps": [
        {
          "id": "s1",
          "label": "Defeat Mom's Heart / It Lives"
    ...
    },
    {
      "id": "boss-rush",
      "name": "Boss Rush",
      "description": "How to reach Boss Rush",
      "steps": [
        {
          "id": "s1",
          "label": "Defeat Mom (Foot) for the first time in the run"
        },
        {
          "id": "s2",
          "label": "Do it within 20 minutes (timer starts at run start)"
        },
        {
          "id": "s3",
          "label": "A big door opens in the Mom boss room"
        },
        {
          "id": "s4",
          "label": "Enter and defeat all waves (Boss Rush)"
        }
      ]
    },
    {
      "id": "greed",
      "name": "Greed Mode",
      "description": "Greed Mode and Ultra Greed",
      "steps": [
        {
          "id": "s1",
          "label": "Select Greed Mode from the main menu (available after defeating Mom)"
        },
        {
          "id": "s2",
          "label": "Start a run in Greed Mode"
        },
        {
          "id": "s3",
          "label": "Clear each floor (waves of enemies, then boss)"
        },
        {
          "id": "s4",
          "label": "Reach the final floor (The Shop)"
        },
        {
          "id": "s5",
          "label": "Defeat Ultra Greed"
        },
        {
          "id": "s6",
          "label": "Optional: defeat Ultra Greedier (unlocked by donating 500+ coins to the Greed Donation Machine)"
        }
      ]
    }
  ],
  "unlocks": [
    {
      "id": "isaac",
      "characterName": "Isaac",
      "targetUnlock": "Starter character",
      "steps": [
        {
          "id": "u1",
          "label": "Isaac is available from the start"
        }
      ],
      "rewards": [
        {
          "boss": "Mom's Heart",
          "unlock": "Lost Baby (co-op)"
        },
        {
          "boss": "Isaac",
          "unlock": "Isaac's Tears"
        },
        {
          "boss": "Satan",
          "unlock": "Mom's Knife"
    ...
    },
    {
      ...
      "targetUnlock": "Unlock Magdalene",
      "steps": [
        {
          "id": "u1",
          "label": "Have 7 or more Red Heart containers at once (any character)"
        },
        {
          "id": "u2",
          "label": "Magdalene is unlocked"
        }
      ],
      "rewards": [
        {
          "boss": "Mom's Heart",
          "unlock": "Cute Baby (co-op)"
        },
        {
          "boss": "Isaac",
          "unlock": "The Relic"
        ...
        {
          "boss": "Mega Satan",
          "unlock": "Red Baby (co-op)"
        },
        {
          "boss": "Greedier",
          "unlock": "Glyph of Balance"
        },
        {
          "boss": "Mother",
          "unlock": "Yuck Heart"
    ...
    },
    {
      "id": "cain",
      "characterName": "Cain",
      "targetUnlock": "Unlock Cain",
      "steps": [
        {
          "id": "u1",
          "label": "Hold 55 or more coins at once (any character)"
        },
        {
          "id": "u2",
          "label": "Cain is unlocked"
        }
      ],
      "rewards": [
        {
          "boss": "Mom's Heart",
          "unlock": "Glass Baby (co-op)"
        },
        {
          "boss": "Isaac",
          "unlock": "Sack of Pennies"
        },
        {
          "boss": "Satan",
          "unlock": "Bomb Bag"
        ...
        {
          "boss": "Delirium",
          "unlock": "Silver Dollar"
        },
        {
          "boss": "Mega Satan",
          "unlock": "Green Baby (co-op)"
        },
        {
          "boss": "Greedier",
          "unlock": "Sack of Sacks"
        },
        {
          "boss": "Mother",
          "unlock": "Guppy's Eye"
    ...
    },
    {
      "id": "judas",
      "characterName": "Judas",
      "targetUnlock": "Unlock Judas",
      "steps": [
        {
          "id": "u1",
          "label": "Defeat Satan in Sheol (any character)"
        },
        {
          "id": "u2",
          "label": "Judas is unlocked"
        }
      ],
      "rewards": [
        {
          "boss": "Mom's Heart",
          "unlock": "Shadow Baby (co-op)"
        },
        {
          "boss": "Isaac",
          "unlock": "Guillotine"
        ...
        {
          "boss": "Mega Satan",
          "unlock": "Brown Baby (co-op)"
        },
        {
          "boss": "Greedier",
          "unlock": "Eye of Belial"
        },
        {
          "boss": "Mother",
          "unlock": "Akeldama"
    ...
    {
      "id": "blue-baby",
      "characterName": "??? (Blue Baby)",
      "targetUnlock": "Unlock ??? (Blue Baby)",
      "steps": [
        {
          "id": "u1",
          "label": "Defeat Mom's Heart 10 times (any character)"
        },
        {
          "id": "u2",
          "label": "??? (Blue Baby) is unlocked"
        }
      ],
      "rewards": [
        {
          "boss": "Mom's Heart",
          "unlock": "Dead Baby (co-op)"
        },
        {
          "boss": "Isaac",
          "unlock": "The D6"
        ...
        {
          "boss": "Boss Rush",
          "unlock": "???'s Only Friend"
        },
        {
          "boss": "Hush",
          "unlock": "Fate's Reward"
        },
        {
          "boss": "Delirium",
          "unlock": "King Baby"
    ...
    },
    {
      "id": "eve",
      "characterName": "Eve",
      "targetUnlock": "Unlock Eve",
      "steps": [
        {
          "id": "u1",
          "label": "Don't pick up any hearts for two consecutive floors (any character)"
        },
        {
          "id": "u2",
          "label": "Eve is unlocked"
        }
      ],
      "rewards": [
        {
          "boss": "Mom's Heart",
          "unlock": "Crow Baby (co-op)"
        },
        {
          "boss": "Isaac",
          "unlock": "Eve's Bird Foot"
        },
        {
          "boss": "Satan",
          "unlock": "Razor Blade"
        ...
        {
          "boss": "???",
          "unlock": "Sacrificial Dagger"
        },
        {
          "boss": "The Lamb",
          "unlock": "Black Lipstick"
        },
        {
          "boss": "Boss Rush",
          "unlock": "Eve's Mascara"
        },
        {
          "boss": "Hush",
          "unlock": "Athame"
    ...
    },
    {
      ...
      "targetUnlock": "Unlock Samson",
      "steps": [
        {
          "id": "u1",
          "label": "Complete two floors in a row without taking damage"
        },
        {
          "id": "u2",
          "label": "Samson is unlocked"
        }
      ],
      "rewards": [
        {
          "boss": "Mom's Heart",
          "unlock": "Fighting Baby (co-op)"
        },
        {
          "boss": "Isaac",
          "unlock": "Bloody Lust"
        ...
        {
          "boss": "The Lamb",
          "unlock": "Samson's Lock"
        },
        {
          "boss": "Boss Rush",
          "unlock": "Samson's Chains"
        },
        {
          "boss": "Hush",
          "unlock": "Blind Rage"
    ...
    },
    {
      ...
      "targetUnlock": "Unlock Azazel",
      "steps": [
        {
          "id": "u1",
          "label": "Make 3 deals with the Devil in one run"
        },
        {
          "id": "u2",
          "label": "Azazel is unlocked"
        }
      ],
      "rewards": [
        {
          "boss": "Mom's Heart",
          "unlock": "Begotten Baby (co-op)"
        },
        {
          "boss": "Isaac",
          "unlock": "Satanic Bible"
        },
        {
          "boss": "Satan",
          "unlock": "Daemon's Tail"
        },
        {
          "boss": "???",
          "unlock": "Abaddon"
        ...
        {
          "boss": "Hush",
          "unlock": "Maw of the Void"
        },
        {
          "boss": "Delirium",
          "unlock": "Dark Prince's Crown"
        },
        {
          "boss": "Mega Satan",
          "unlock": "Black Baby (co-op)"
        },
        {
          "boss": "Greedier",
          "unlock": "Bat Wing"
    ...
    {
      "id": "lazarus",
      "characterName": "Lazarus",
      "targetUnlock": "Unlock Lazarus",
      "steps": [
        {
          "id": "u1",
          "label": "Have 4 or more Soul Hearts or Black Hearts at once (any character)"
        },
        {
          "id": "u2",
          "label": "Lazarus is unlocked"
        }
      ],
      "rewards": [
        {
          "boss": "Mom's Heart",
          "unlock": "Wrapped Baby (co-op)"
        },
        {
          "boss": "Isaac",
          "unlock": "Lazarus' Rags"
        ...
        {
          "boss": "Delirium",
          "unlock": "Compound Fracture"
        },
        {
          "boss": "Mega Satan",
          "unlock": "Long Baby (co-op)"
        },
        {
          "boss": "Greedier",
          "unlock": "Plan C"
    ...
    },
    {
      "id": "eden",
      "characterName": "Eden",
      "targetUnlock": "Unlock Eden",
      "steps": [
        {
          "id": "u1",
          "label": "Defeat Mom's Heart for the first time (any character)"
        },
        {
          "id": "u2",
          "label": "Eden is unlocked (costs 1 Eden Token per run)"
        }
      ],
      "rewards": [
        {
          "boss": "Mom's Heart",
          "unlock": "Glitch Baby (co-op)"
        },
        {
          "boss": "Isaac",
          "unlock": "Blank Card"
        ...
        {
          "boss": "Satan",
          "unlock": "Book of Secrets"
        },
        {
          "boss": "???",
          "unlock": "Mysterious Paper"
        },
        {
          "boss": "The Lamb",
          "unlock": "Mystery Sack"
        ...
        {
          "boss": "The Beast",
          "unlock": "Everything Jar"
        }
      ]
    },
    {
      "id": "the-lost",
      "characterName": "The Lost",
      "targetUnlock": "Unlock The Lost",
      "steps": [
        {
          "id": "u1",
          "label": "Find the Missing Poster trinket"
        },
        {
          "id": "u2",
          "label": "Die in a Sacrifice Room while holding Missing Poster"
        },
        {
          "id": "u3",
          "label": "The Lost is unlocked"
        }
      ],
      "rewards": [
        {
        ...
        {
          "boss": "Mega Satan",
          "unlock": "White Baby (co-op)"
        },
        {
          "boss": "Greedier",
          "unlock": "Dad's Lost Coin"
        },
        {
          "boss": "Mother",
          "unlock": "Lost Soul"
    ...
    },
    {
      ...
      "targetUnlock": "Unlock Lilith",
      "steps": [
        {
          "id": "u1",
          "label": "Defeat Ultra Greed in Greed Mode as Azazel"
        },
        {
          "id": "u2",
          "label": "Lilith is unlocked"
        }
      ],
      "rewards": [
        {
          "boss": "Mom's Heart",
          "unlock": "Goat Head Baby (co-op)"
        },
        {
          "boss": "Isaac",
          "unlock": "Rune Bag"
        ...
        {
          "boss": "Satan",
          "unlock": "Serpent's Kiss"
        },
        {
          "boss": "???",
          "unlock": "Cambion Conception"
        },
        {
          "boss": "The Lamb",
          "unlock": "Succubus"
    ...
    },
    {
      ...
      "targetUnlock": "Unlock Keeper",
      "steps": [
        {
          "id": "u1",
          "label": "Play Greed Mode and defeat Ultra Greed"
        },
        {
          "id": "u2",
          "label": "Donate coins to the Greed Machine after the fight"
        },
        {
          "id": "u3",
          "label": "Accumulate 1000 total coins in the Greed Machine across multiple runs"
        },
        {
          "id": "u4",
          "label": "The machine jams more often the more you've donated — switch characters to reduce jam chance"
        },
        {
          "id": "u5",
          "label": "Keeper is unlocked at 1000 coins"
        }
      ],
      "rewards": [
        {
          "boss": "Mom's Heart",
          "unlock": "Super Greed Baby (co-op)"
        },
        {
          "boss": "Isaac",
          "unlock": "Wooden Nickel"
        },
        {
          "boss": "Satan",
          "unlock": "Store Key"
        ...
        {
          "boss": "Boss Rush",
          "unlock": "Sticky Nickels"
        },
        {
          "boss": "Hush",
          "unlock": "Keeper's Penny"
        },
        {
          "boss": "Delirium",
          "unlock": "Crooked Penny"
        },
        {
          "boss": "Mega Satan",
          "unlock": "Noose Baby (co-op)"
        },
        {
          "boss": "Greedier",
          "unlock": "Eye of Greed"
    ...
    {
      "id": "apollyon",
      "characterName": "Apollyon",
      "targetUnlock": "Unlock Apollyon",
      "steps": [
        {
          "id": "u1",
          "label": "Defeat Mega Satan (any character)"
        },
        {
          "id": "u2",
          "label": "Apollyon is unlocked"
        }
      ],
      "rewards": [
        {
        ...
        {
          "boss": "Isaac",
          "unlock": "Locust of Wrath"
        },
        {
          "boss": "Satan",
          "unlock": "Locust of Pestilence"
        },
        {
          "boss": "???",
          "unlock": "Locust of Famine"
        },
        {
          "boss": "The Lamb",
          "unlock": "Locust of Death"
        },
        {
          "boss": "Boss Rush",
          "unlock": "Locust of Conquest"
        },
        {
          "boss": "Hush",
          "unlock": "Hushy"
    ...
    },
    {
      ...
      "steps": [
        {
          "id": "u1",
          "label": "Start a run as any character (must have defeated the Lamb at least once)"
        },
        {
          "id": "u2",
          "label": "Defeat the first floor boss within 1 minute of starting the run"
        },
        {
          "id": "u3",
          "label": "After beating the boss, Mom's Foot starts stomping periodically"
        },
        {
          "id": "u4",
          "label": "Go back to the starting room and bomb the ground to find Broken Shovel piece 1"
        },
        {
          "id": "u5",
          "label": "Survive Mom's stomps (every few seconds) while carrying the Broken Shovel"
        },
        {
          "id": "u6",
          "label": "Reach and complete Boss Rush (must defeat Mom within 20 minutes)"
        },
        {
          "id": "u7",
          "label": "Broken Shovel piece 2 drops after Boss Rush — combine into Mom's Shovel"
        },
        {
          "id": "u8",
          "label": "Mom's stomps stop once you have Mom's Shovel"
        },
        {
          "id": "u9",
          "label": "Continue to the Dark Room (take the Negative, defeat The Lamb path)"
        },
        {
          "id": "u10",
          "label": "Find the dirt patch in the Dark Room and use Mom's Shovel on it"
        },
        {
          "id": "u11",
          "label": "The Forgotten is unlocked"
        }
      ],
      "rewards": [
        {
        ...
        {
          "boss": "The Lamb",
          "unlock": "Brittle Bones"
        },
        {
          "boss": "Boss Rush",
          "unlock": "Divorce Papers"
        },
        {
          "boss": "Hush",
          "unlock": "Hallowed Ground"
        },
        {
          "boss": "Delirium",
          "unlock": "Book of the Dead"
        },
        {
          "boss": "Mega Satan",
          "unlock": "Bound Baby (co-op)"
        },
        {
          "boss": "Greedier",
          "unlock": "Dad's Ring"
        ...
        {
          "boss": "The Beast",
          "unlock": "Spirit Shackles"
        }
      ]
    },
    {
      "id": "bethany",
      "characterName": "Bethany",
      "targetUnlock": "Unlock Bethany",
      "steps": [
        {
          "id": "u1",
          "label": "Play as Lazarus on Hard difficulty"
        },
        {
          "id": "u2",
          "label": "Defeat Mom's Heart WITHOUT dying (do not use Lazarus' extra life)"
        },
        {
          "id": "u3",
          "label": "You must survive the entire run as Lazarus, not Lazarus Risen"
        },
        {
          "id": "u4",
          "label": "Bethany is unlocked"
        }
      ],
      "rewards": [
        {
          "boss": "Mom's Heart",
          "unlock": "Wisp Baby (co-op)"
        },
        {
          "boss": "Isaac",
          "unlock": "Book of Virtues"
        },
        {
          "boss": "Satan",
          "unlock": "Urn of Souls"
        ...
        {
          "boss": "???",
          "unlock": "Blessed Penny"
        },
        {
          "boss": "The Lamb",
          "unlock": "Alabaster Box"
        },
        {
          "boss": "Boss Rush",
          "unlock": "Beth's Faith"
        ...
        {
          "boss": "Hush",
          "unlock": "Divine Intervention"
        },
        {
          "boss": "Delirium",
          "unlock": "Star of Bethlehem"
        },
        {
          "boss": "Mega Satan",
          "unlock": "Glowing Baby (co-op)"
        },
        {
          "boss": "Greedier",
          "unlock": "Vade Retro"
    ...
    {
      "id": "jacob-esau",
      "characterName": "Jacob & Esau",
      "targetUnlock": "Unlock Jacob and Esau",
      "steps": [
        {
          "id": "u1",
          "label": "Defeat Mother as any character (complete the alt path)"
        },
        {
          "id": "u2",
          "label": "Jacob & Esau are unlocked"
        }
      ],
      "rewards": [
        {
          "boss": "Mom's Heart",
          "unlock": "Double Baby (co-op)"
        },
        {
          "boss": "Isaac",
          "unlock": "The Stairway"
        ...
        {
          "boss": "The Beast",
          "unlock": "Friend Finder"
        }
      ]
    },
    {
      "id": "tainted-isaac",
      "characterName": "Tainted Isaac",
      "targetUnlock": "Unlock Tainted Isaac",
      "steps": [
        {
          "id": "u1",
          "label": "Reach Home as Isaac (pick up Dad's Note in Mausoleum, ascend through all floors)"
        },
        {
          "id": "u2",
          "label": "In the hallway of Home, use Red Key or Cracked Key on the wall"
        },
        {
          "id": "u3",
          "label": "Enter the hidden red room and touch the ghostly character inside"
        },
        {
          "id": "u4",
          "label": "Tainted Isaac is unlocked"
        }
      ],
      "rewards": [
        {
          "boss": "Isaac / ??? / Satan / The Lamb",
          "unlock": "Mom's Lock"
        },
        {
          "boss": "Boss Rush / Hush",
          "unlock": "Soul of Isaac"
        },
        {
          "boss": "Delirium",
          "unlock": "Spindown Dice"
        },
        {
          "boss": "Mega Satan",
          "unlock": "Mega Chest"
        ...
        {
          "boss": "The Beast",
          "unlock": "Glitched Crown"
        }
      ]
    },
    {
      "id": "tainted-magdalene",
      "characterName": "Tainted Magdalene",
      "targetUnlock": "Unlock Tainted Magdalene",
      "steps": [
        {
          "id": "u1",
          "label": "Reach Home as Magdalene"
        },
        {
          "id": "u2",
          "label": "Use the Red Key or Cracked Key on the hallway wall in Home"
        },
        {
          "id": "u3",
          "label": "Enter the red room and touch the character inside"
        },
        {
          "id": "u4",
          "label": "Tainted Magdalene is unlocked"
        }
      ],
      "rewards": [
        {
        ...
        {
          "boss": "Boss Rush / Hush",
          "unlock": "Soul of Magdalene"
        },
        {
          "boss": "Delirium",
          "unlock": "Hypercoagulation"
        },
        {
          "boss": "Mega Satan",
          "unlock": "Queen of Hearts"
        },
        {
          "boss": "Greedier",
          "unlock": "The Lovers?"
    ...
    },
    {
      ...
      "targetUnlock": "Unlock Tainted Cain",
      "steps": [
        {
          "id": "u1",
          "label": "Reach Home as Cain"
        },
        {
          "id": "u2",
          "label": "Use the Red Key or Cracked Key on the hallway wall in Home"
        ...
        {
          "id": "u4",
          "label": "Tainted Cain is unlocked"
        }
      ],
      "rewards": [
        {
    ...
    {
      "id": "tainted-judas",
      "characterName": "Tainted Judas",
      "targetUnlock": "Unlock Tainted Judas",
      "steps": [
        {
          "id": "u1",
          "label": "Reach Home as Judas"
        },
        {
          "id": "u2",
          "label": "Use the Red Key or Cracked Key on the hallway wall in Home"
        ...
        {
          "id": "u4",
          "label": "Tainted Judas is unlocked"
        }
      ],
      "rewards": [
        {
        ...
        {
          "boss": "Mother",
          "unlock": "Number Magnet"
        },
        {
          "boss": "The Beast",
          "unlock": "Sanguine Bond"
        }
      ]
    },
    {
      "id": "tainted-blue-baby",
      "characterName": "Tainted ??? (Blue Baby)",
      "targetUnlock": "Unlock Tainted ???",
      "steps": [
        {
          "id": "u1",
          "label": "Reach Home as ??? (Blue Baby)"
        },
        {
          "id": "u2",
          "label": "Use the Red Key or Cracked Key on the hallway wall in Home"
    ...
    {
      "id": "tainted-eve",
      "characterName": "Tainted Eve",
      "targetUnlock": "Unlock Tainted Eve",
      "steps": [
        {
          "id": "u1",
          "label": "Reach Home as Eve"
        },
        {
          "id": "u2",
          "label": "Use the Red Key or Cracked Key on the hallway wall in Home"
    ...
    {
      "id": "tainted-samson",
      "characterName": "Tainted Samson",
      "targetUnlock": "Unlock Tainted Samson",
      "steps": [
        {
          "id": "u1",
          "label": "Reach Home as Samson"
        },
        {
          "id": "u2",
          "label": "Use the Red Key or Cracked Key on the hallway wall in Home"
        ...
        {
          "id": "u4",
          "label": "Tainted Samson is unlocked"
        }
      ],
      "rewards": [
        {
          "boss": "Isaac / ??? / Satan / The Lamb",
          "unlock": "Temporary Tattoo"
        },
        {
          "boss": "Boss Rush / Hush",
          "unlock": "Soul of Samson"
        },
        {
          "boss": "Delirium",
          "unlock": "Berserk!"
    ...
    {
      "id": "tainted-azazel",
      "characterName": "Tainted Azazel",
      "targetUnlock": "Unlock Tainted Azazel",
      "steps": [
        {
          "id": "u1",
          "label": "Reach Home as Azazel"
        },
        {
          "id": "u2",
          "label": "Use the Red Key or Cracked Key on the hallway wall in Home"
        ...
        {
          "id": "u4",
          "label": "Tainted Azazel is unlocked"
        }
      ],
      "rewards": [
        {
        ...
        {
          "boss": "Mother",
          "unlock": "Azazel's Stump"
        },
        {
          "boss": "The Beast",
          "unlock": "Azazel's Rage"
        }
      ]
    },
    {
      ...
      "targetUnlock": "Unlock Tainted Lazarus",
      "steps": [
        {
          "id": "u1",
          "label": "Reach Home as Lazarus"
        },
        {
          "id": "u2",
          "label": "Use the Red Key or Cracked Key on the hallway wall in Home"
        ...
        {
          "id": "u4",
          "label": "Tainted Lazarus is unlocked"
        }
      ],
      "rewards": [
        {
    ...
    {
      "id": "tainted-eden",
      "characterName": "Tainted Eden",
      "targetUnlock": "Unlock Tainted Eden",
      "steps": [
        {
          "id": "u1",
          "label": "Reach Home as Eden"
        },
        {
          "id": "u2",
          "label": "Use the Red Key or Cracked Key on the hallway wall in Home"
        ...
        {
          "id": "u4",
          "label": "Tainted Eden is unlocked"
        }
      ],
      "rewards": [
        {
    ...
    {
      "id": "tainted-lost",
      "characterName": "Tainted Lost",
      "targetUnlock": "Unlock Tainted Lost",
      "steps": [
        {
          "id": "u1",
          "label": "Reach Home as The Lost"
        },
        {
          "id": "u2",
          "label": "Use the Red Key or Cracked Key on the hallway wall in Home"
        ...
        {
          "id": "u4",
          "label": "Tainted Lost is unlocked"
        }
      ],
      "rewards": [
        {
          "boss": "Isaac / ??? / Satan / The Lamb",
          "unlock": "Kid's Drawing"
        },
        {
          "boss": "Boss Rush / Hush",
          "unlock": "Soul of the Lost"
        },
        {
          "boss": "Delirium",
          "unlock": "Ghost Bombs"
    ...
    },
    {
      ...
      "targetUnlock": "Unlock Tainted Lilith",
      "steps": [
        {
          "id": "u1",
          "label": "Reach Home as Lilith"
        },
        {
          "id": "u2",
          "label": "Use the Red Key or Cracked Key on the hallway wall in Home"
        ...
        {
          "id": "u4",
          "label": "Tainted Lilith is unlocked"
        }
      ],
      "rewards": [
        {
        ...
        {
          "boss": "Greedier",
          "unlock": "The High Priestess?"
        },
        {
          "boss": "Mother",
          "unlock": "Adoption Papers"
        },
        {
          "boss": "The Beast",
          "unlock": "Twisted Pair"
    ...
    {
      "id": "tainted-keeper",
      "characterName": "Tainted Keeper",
      "targetUnlock": "Unlock Tainted Keeper",
      "steps": [
        {
          "id": "u1",
          "label": "Reach Home as Keeper"
        },
        {
          "id": "u2",
          "label": "Use the Red Key or Cracked Key on the hallway wall in Home"
        ...
        {
          "id": "u4",
          "label": "Tainted Keeper is unlocked"
        }
      ],
      "rewards": [
        {
          "boss": "Isaac / ??? / Satan / The Lamb",
          "unlock": "Keeper's Bargain"
        },
        {
          "boss": "Boss Rush / Hush",
          "unlock": "Soul of the Keeper"
        },
        {
          "boss": "Delirium",
          "unlock": "Keeper's Kin"
    ...
    {
      "id": "tainted-apollyon",
      "characterName": "Tainted Apollyon",
      "targetUnlock": "Unlock Tainted Apollyon",
      "steps": [
        {
          "id": "u1",
          "label": "Reach Home as Apollyon"
        },
        {
          "id": "u2",
          "label": "Use the Red Key or Cracked Key on the hallway wall in Home"
        ...
        {
          "id": "u4",
          "label": "Tainted Apollyon is unlocked"
        }
      ],
      "rewards": [
        {
    ...
    },
    {
      ...
      "characterName": "Tainted Forgotten",
      "targetUnlock": "Unlock Tainted Forgotten",
      "steps": [
        {
          "id": "u1",
          "label": "Reach Home as The Forgotten"
        },
        {
          "id": "u2",
          "label": "Use the Red Key or Cracked Key on the hallway wall in Home"
        ...
        {
          "id": "u4",
          "label": "Tainted Forgotten is unlocked"
        }
      ],
      "rewards": [
        {
          "boss": "Isaac / ??? / Satan / The Lamb",
          "unlock": "Polished Bone"
        },
        {
          "boss": "Boss Rush / Hush",
          "unlock": "Soul of the Forgotten"
        },
        {
          "boss": "Delirium",
          "unlock": "Decap Attack"
    ...
    {
      "id": "tainted-bethany",
      "characterName": "Tainted Bethany",
      "targetUnlock": "Unlock Tainted Bethany",
      "steps": [
        {
          "id": "u1",
          "label": "Reach Home as Bethany"
        },
        {
          "id": "u2",
          "label": "Use the Red Key or Cracked Key on the hallway wall in Home"
        ...
        {
          "id": "u4",
          "label": "Tainted Bethany is unlocked"
        }
      ],
      "rewards": [
        {
          "boss": "Isaac / ??? / Satan / The Lamb",
          "unlock": "Expansion Pack"
        },
        {
          "boss": "Boss Rush / Hush",
          "unlock": "Soul of Bethany"
        },
        {
          "boss": "Delirium",
          "unlock": "Lemegeton"
        ...
        {
          "boss": "Greedier",
          "unlock": "The Hierophant?"
        },
        {
          "boss": "Mother",
          "unlock": "Beth's Essence"
        },
        {
          "boss": "The Beast",
          "unlock": "Vengeful Spirit"
        }
      ]
    },
    {
      "id": "tainted-jacob",
      "characterName": "Tainted Jacob",
      "targetUnlock": "Unlock Tainted Jacob",
      "steps": [
        {
          "id": "u1",
          "label": "Reach Home as Jacob & Esau"
        },
        {
          "id": "u2",
          "label": "Use the Red Key or Cracked Key on the hallway wall in Home"
        ...
        {
          "id": "u4",
          "label": "Tainted Jacob is unlocked"
        }
      ],
      "rewards": [
        {
  ...
  "challenges": [
    {
      ...
      "number": 1,
      "name": "Pitch Black",
      "description": "Permanent Curse of Darkness. Navigate in near-total darkness.",
      "character": "Isaac",
      "goal": "Mom",
      "unlock": "Rune of Hagalaz",
      "restrictions": [
        "Curse of Darkness (permanent)"
      ],
      "difficulty": "easy"
    },
    {
      ...
      "number": 2,
      "name": "High Brow",
      "description": "Start with a poop-themed loadout. Number One + E. Coli + Butt Bombs + Flush! + Petrified Poop.",
      "character": "Isaac",
      "goal": "Mom",
      "unlock": "Rune of Jera",
      "restrictions": [
    ...
    },
    {
      ...
      "number": 3,
      "name": "Head Trauma",
      "description": "Start with Tiny Planet, Soy Milk, Iron Bar, and The Small Rock. Tears orbit around you with very high fire rate but low damage.",
      "character": "Isaac",
      "goal": "Mom",
      "unlock": "Rune of Ehwaz",
      "restrictions": [
        "Fixed items",
        "Orbiting tiny tears"
      ],
    ...
    },
    {
      ...
      "number": 4,
      "name": "Darkness Falls",
      "description": "Play as Eve with extra devil items. Start with Razor Blade, Dark Matter, Pentagram, and Sacrificial Dagger.",
      "character": "Eve",
      "goal": "Satan",
      "unlock": "Rune of Dagaz",
      "restrictions": [
        "Fixed items"
      ],
      "difficulty": "medium"
    },
    {
      ...
      "number": 5,
      "name": "The Tank",
      "description": "Very slow but tanky. Magdalene with Thunder Thighs, Bucket of Lard, and Infamy.",
      "character": "Magdalene",
      "goal": "Mom",
      "unlock": "Rune of Ansuz",
      "restrictions": [
        "Fixed items",
        "Very slow speed"
      ],
    ...
    },
    {
      ...
      "number": 6,
      "name": "Solar System",
      "description": "Orbital-only run. Blindfolded — rely entirely on orbitals for damage. Start with Distant Admiration, Forever Alone, Halo of Flies, and Transcendence.",
      "character": "Isaac",
      "goal": "Mom's Heart",
      "unlock": "Rune of Perthro",
      "restrictions": [
        "No tears (Blindfolded)",
        "Orbitals only"
      ],
      "difficulty": "medium"
    },
    {
      ...
      "number": 7,
      "name": "Suicide King",
      "description": "Play as Lazarus. Start with Ipecac, My Reflection, and Mr. Mega. Explosive tears boomerang back toward you. Extremely dangerous.",
      "character": "Lazarus",
      "goal": "Isaac",
      "unlock": "Suicide King (card)",
      "restrictions": [
        "Fixed items",
        "Explosive boomerang tears",
        "High self-damage risk"
      ],
      "difficulty": "hard"
    },
    {
      ...
      "description": "Guppy transformation from the start. Blindfolded — flies do the damage. Start with Guppy's Tail, Guppy's Head, and Guppy's Hairball.",
      "character": "Isaac",
      "goal": "Mom",
      "unlock": "Rune of Algiz",
      "restrictions": [
        "No tears (Blindfolded)",
        "Guppy flies only"
      ],
    ...
    },
    {
      ...
      "number": 9,
      "name": "Demo Man",
      "description": "Start with Dr. Fetus, Remote Detonator, and Match Stick. All tears are bombs you control.",
      "character": "Isaac",
      "goal": "Mom's Heart",
      "unlock": "Chaos Card",
      "restrictions": [
    ...
    },
    {
      ...
      "number": 10,
      "name": "Cursed!",
      "description": "Play as Magdalene. Permanent Curse of the Labyrinth — every floor is an XL floor. Start with Treasure Map, Compass, Blue Map, Raw Liver, and Child's Heart.",
      "character": "Magdalene",
      "goal": "Mom",
      "unlock": "Credit Card",
      "restrictions": [
        "Curse of the Labyrinth (permanent)"
      ],
      "difficulty": "easy"
    },
    {
      ...
      "number": 11,
      "name": "Glass Cannon",
      "description": "Play as Judas. Start with Epic Fetus and Loki's Horns. One-hit potential but extremely fragile.",
      "character": "Judas",
      "goal": "Satan",
      "unlock": "Rules Card",
      "restrictions": [
    ...
    },
    {
      ...
      "description": "Start with Lemon Mishap, Habit, 9 Volt, and a Lemon Party pill. Lemon-themed run.",
      "character": "Isaac",
      "goal": "Mom",
      "unlock": "A Card Against Humanity",
      "restrictions": [
        "Fixed items"
      ],
      "difficulty": "easy"
    },
    {
      ...
      "number": 13,
      "name": "Beans!",
      "description": "Bean-themed run. Start with Butt Bombs, Pyro, The Black Bean, The Bean, and 9 Volt.",
      "character": "Isaac",
      "goal": "Mom",
      "unlock": "Burnt Penny",
      "restrictions": [
    ...
    },
    {
      ...
      "description": "Start with Starter Deck, Deck of Cards, 9 Volt, The Battery, and a random card. Use cards to survive.",
      "character": "Isaac",
      "goal": "Mom",
      "unlock": "SMB Super Fan",
      "restrictions": [
        "Fixed items"
      ],
      "difficulty": "easy"
    },
    {
      ...
      "number": 15,
      "name": "Slow Roll",
      "description": "Start with Polyphemus, Cupid's Arrow, and My Reflection. Huge slow piercing tears.",
      "character": "Isaac",
      "goal": "Mom",
      "unlock": "Swallowed Penny",
      "restrictions": [
        "Fixed items",
        "Slow fire rate"
      ],
    ...
    },
    {
      ...
      "number": 16,
      "name": "Computer Savvy",
      "description": "Start with Technology, Technology 2, and Spoon Bender. Laser loadout.",
      "character": "Isaac",
      "goal": "Mom",
      "unlock": "Robo-Baby 2.0",
      "restrictions": [
        "Fixed items"
      ],
      "difficulty": "easy"
    },
    {
      ...
      "number": 17,
      "name": "Waka Waka",
      "description": "Start with Strange Attractor and Anti-Gravity. Tears pull enemies.",
      "character": "Isaac",
      "goal": "Mom",
      "unlock": "Death's Touch",
      "restrictions": [
        "Fixed items"
      ],
      "difficulty": "medium"
    },
    {
      ...
      "number": 18,
      "name": "The Host",
      "description": "Start with The Mulligan, Spiderbaby, and The Tick. Blindfolded — familiars fight for you.",
      "character": "Isaac",
      "goal": "Mom",
      "unlock": "Tech.5",
      "restrictions": [
    ...
    },
    {
      ...
      "number": 19,
      "name": "The Family Man",
      "description": "Blindfolded. Start with Dad's Key, Sister Maggy, Brother Bobby, Rotten Baby, and BFFS! Familiars do all the damage.",
      "character": "Isaac",
      "goal": "Isaac",
      "unlock": "Epic Fetus",
      "restrictions": [
    ...
    },
    {
      ...
      "number": 20,
      "name": "Purist",
      "description": "No item rooms spawn at all. You only get boss items and any pickups you find. Pure skill and resource management.",
      "character": "Isaac",
      "goal": "Mom's Heart",
      "unlock": "Rune of Berkano",
      "restrictions": [
        "No treasure rooms",
        "No item rooms"
      ],
    ...
    },
    {
      ...
      "number": 21,
      "name": "XXXXXXXXL",
      "description": "Every floor is the size of an XL Womb floor. Massive floors to explore.",
      "character": "Isaac",
      "goal": "Mom's Heart",
      "unlock": "Gold Heart",
      "restrictions": [
        "XXL floors (permanent)"
      ],
      "difficulty": "medium"
    },
    {
      ...
      "number": 22,
      "name": "SPEED!",
      "description": "Enemies are sped up, Isaac moves faster. Must clear rooms quickly.",
      "character": "Isaac",
      "goal": "Mom's Heart",
      "unlock": "Get Out of Jail Free Card",
      "restrictions": [
        "Sped-up enemies",
        "Must rush"
      ],
    ...
    },
    {
      ...
      "number": 23,
      "name": "Blue Bomber",
      "description": "Play as ???. Start with Kamikaze!, Mr. Mega, Pyromaniac, and Brother Bobby. Bomb yourself to heal.",
      "character": "??? (Blue Baby)",
      "goal": "Satan",
      "unlock": "Golden Bomb",
      "restrictions": [
    ...
    },
    {
      ...
      "number": 24,
      "name": "PAY TO PLAY",
      "description": "All doors cost a coin. Start with Sack of Pennies and Money = Power. Having 0 coins kills you. Taking damage drops coins.",
      "character": "Isaac",
      "goal": "Isaac",
      "unlock": "Percs! + Addicted! (pills)",
      "restrictions": [
        "Doors cost coins",
        "0 coins = death"
      ],
    ...
    },
    {
      ...
      "number": 25,
      "name": "Have a Heart",
      "description": "All red heart pickups are replaced with coins. HP up items no longer heal. Start with Charm of the Vampire.",
      "character": "Isaac",
      "goal": "Mom's Heart",
      "unlock": "Re-Lax + ??? (pills)",
      "restrictions": [
        "No red heart pickups",
        "No healing from HP ups"
      ],
      "difficulty": "medium"
    },
    {
      ...
      "number": 26,
      "name": "I RULE!",
      "description": "Zelda-themed. Start with Mom's Knife, Trinity Shield, The Boomerang, The Ladder, and both Key Pieces.",
      "character": "Isaac",
      "goal": "Mega Satan",
      "unlock": "Poker Chip",
      "restrictions": [
    ...
    },
    {
      ...
      "number": 27,
      "name": "BRAINS!",
      "description": "Play as ???. Blindfolded with 3 Bob's Brains and Thunder Thighs. Brains do all damage.",
      "character": "??? (Blue Baby)",
      "goal": "???",
      "unlock": "Stud Finder",
      "restrictions": [
    ...
    },
    {
      ...
      "number": 28,
      "name": "PRIDE DAY!",
      "description": "Start with Rainbow Baby, 3 Dollar Bill, and Rainbow Worm (can't be dropped). No treasure rooms.",
      "character": "Isaac",
      "goal": "Mom's Heart",
      "unlock": "D8",
      "restrictions": [
        "No treasure rooms",
        "Rainbow Worm permanent"
      ],
      "difficulty": "medium"
    },
    {
      ...
      "number": 29,
      "name": "Onan's Streak",
      "description": "Play as Judas with Chocolate Milk and +2 damage. Missing a shot deals half a heart of damage. Aim carefully.",
      "character": "Judas",
      "goal": "Isaac",
      "unlock": "Kidney Stone",
      "restrictions": [
        "Missed tear = half heart damage",
        "Must not miss"
      ],
      "difficulty": "hard"
    },
    {
      ...
      "number": 30,
      "name": "The Guardian",
      "description": "Blindfolded. Isaac's Heart follows Punching Bag instead of you. Start with Holy Grail and Spear of Destiny. Protect the heart.",
      "character": "Isaac",
      "goal": "Mom's Heart",
      "unlock": "Blank Rune",
      "restrictions": [
    ...
    },
    {
      ...
      "number": 31,
      "name": "Backasswards",
      "description": "Start from Mega Satan with 8-10 random items. Each floor you go backwards, losing a heart container and your oldest item. Floors go in reverse order.",
      "character": "Isaac",
      "goal": "Basement I",
      "unlock": "Lazarus starts with Anemic",
      "restrictions": [
        "Floors in reverse order",
        "One item removed per floor",
    ...
    },
    {
      ...
      "number": 32,
      "name": "Aprils Fool",
      "description": "Every floor boss is The Bloat. All items, trinkets, pickups display incorrect sprites. Active items trigger random effects. Your map position is randomized.",
      "character": "Isaac",
      "goal": "Mom's Heart",
      "unlock": "Magdalene starts with Full Health pill",
      "restrictions": [
        "Everything visually randomized",
        "The Bloat every floor"
      ],
      "difficulty": "medium"
    },
    {
      ...
      "number": 33,
      "name": "Pokey Mans",
      "description": "Blindfolded. Start with Mom's Eyeshadow and Friendly Ball. Friendly Ball spawns random friendly monsters instead of capturing. Auto-recharges when the monster dies.",
      "character": "Isaac",
      "goal": "Isaac",
      "unlock": "Charged Key",
      "restrictions": [
        "No tears (Blindfolded)",
        "Friendly Ball mechanic"
      ],
      "difficulty": "hard"
    },
    {
      ...
      "number": 34,
      "name": "Ultra Hard",
      "description": "No heart drops at all. All enemies are champions. Boss fights are double trouble. Start with both Key Pieces. Must defeat Mega Satan.",
      "character": "Isaac",
      "goal": "Mega Satan",
      "unlock": "Samson starts with Child's Heart",
      "restrictions": [
        "No heart drops of any kind",
        "All enemies are champions",
        "Double trouble bosses",
        "Must defeat Mega Satan"
      ],
      "difficulty": "extreme"
    },
    {
      ...
      "number": 35,
      "name": "Pong",
      "description": "Blindfolded. Start with Cupid's Arrow and Rubber Cement. High range, bouncing piercing tears.",
      "character": "Isaac",
      "goal": "???",
      "unlock": "Greed's Gullet",
      "restrictions": [
        "No tears (Blindfolded)",
        "Bouncing piercing tears"
      ],
      "difficulty": "easy"
    },
    {
      ...
      "number": 36,
      "name": "Scat Man",
      "description": "Poop-themed run. Start with Skatole, The Poop, E. Coli, Butt Bombs, BFFS!, Thunder Thighs, Dirty Mind, 9 Volt, and Mysterious Candy.",
      "character": "Isaac",
      "goal": "Mom",
      "unlock": "Dirty Mind",
      "restrictions": [
    ...
    },
    {
      ...
      "number": 37,
      "name": "Bloody Mary",
      "description": "Play as Bethany (without Book of Virtues). Start with Book of Belial, Blood Bag, Anemic, Blood Oath, and Child's Heart.",
      "character": "Bethany",
      "goal": "Satan",
      "unlock": "Sigil of Baphomet",
      "restrictions": [
        "Fixed items",
        "No Book of Virtues"
      ],
    ...
    },
    {
      ...
      "description": "Play as Bethany (without Book of Virtues). Start with Schoolbag, Guppy's Paw, Urn of Souls, and Maggy's Faith.",
      "character": "Bethany",
      "goal": "Isaac",
      "unlock": "Purgatory",
      "restrictions": [
    ...
    },
    {
      ...
      "description": "Zelda-inspired. Start with Spirit Sword, Mom's Bracelet, and Trinity Shield.",
      "character": "Isaac",
      "goal": "Mother",
      "unlock": "Spirit Sword",
      "restrictions": [
    ...
    },
    {
      ...
      "number": 40,
      "name": "Seeing Double",
      "description": "Play as Jacob & Esau. Both start with 20/20. All enemies and bosses are doubled.",
      "character": "Jacob & Esau",
      "goal": "Mom's Heart",
      "unlock": "Broken Glasses",
      "restrictions": [
        "Double enemies and bosses"
      ],
      "difficulty": "hard"
    },
    {
      ...
      "number": 41,
      "name": "Pica Run",
      "description": "Start with Mom's Purse, Marbles, and Mom's Box. All items are replaced with trinkets. Marbles activates on every hit.",
      "character": "Isaac",
      "goal": "Isaac",
      "unlock": "Ice Cube",
      "restrictions": [
        "All items replaced with trinkets",
        "Marbles activates on hit"
      ],
      "difficulty": "medium"
    },
    {
      ...
      "number": 42,
      "name": "Hot Potato",
      "description": "Play as Tainted Forgotten. The Forgotten explodes every 2.5 seconds, damaging The Soul.",
    ...
    },
    {
      ...
      "number": 43,
      "name": "Cantripped",
      "description": "Play as Tainted Cain. Cards and pills replaced with Item Cards. Bag of Crafting starts with 3 card slots. Every item replaced by Starter Deck which grants +1 slot and spawns 3 Item Cards.",
      "character": "Tainted Cain",
      "goal": "Mom",
      "unlock": "Justice?",
      "restrictions": [
        "Tainted Cain mechanics",
        "Item Card system"
      ],
      "difficulty": "medium"
    },
    {
      ...
      "number": 44,
      "name": "Red Redemption",
      "description": "Play as Tainted Jacob with Dad's Key. Rooms must be found via Red Key. After 20 uses, Dark Esau spawns. Every 5 more uses spawns another. XL floors with scattered room clusters.",
    ...
    },
    {
      ...
      "number": 45,
      "name": "DELETE THIS",
      "description": "Play as Isaac with TMTRAINER. Area themes, obstacles, floor textures, and music are randomized. Shop prices vary wildly. The challenge appears invisible in the Challenge List.",
      "character": "Isaac",
      "goal": "???",
      "unlock": "Temperance?",
      "restrictions": [
        "TMTRAINER glitched items",
  ...
  "transformations": [
    {
      "id": "guppy",
      "name": "Guppy",
      "description": "Gain flight and spawn blue flies when hitting enemies with tears",
      "requires": 3,
      "items": [
        "Dead Cat",
        "Guppy's Head",
        ...
        "Guppy's Hairball",
        "Guppy's Collar",
        "Kid's Drawing (trinket)"
      ]
    },
    {
      "id": "beelzebub",
      "name": "Beelzebub",
      "description": "Gain flight and turn small enemy flies into friendly blue flies",
      "requires": 3,
      "items": [
        "???'s Only Friend",
        "Angry Fly",
    ...
    },
    {
      "id": "fun-guy",
      "name": "Fun Guy",
      "description": "Gain 1 Red Heart container",
      "requires": 3,
      "items": [
        "1up!",
        "Blue Cap",
    ...
    },
    {
      "id": "seraphim",
      "name": "Seraphim",
      "description": "Gain flight and 3 Soul Hearts",
      "requires": 3,
      "items": [
        "The Bible",
        "Celtic Cross",
    ...
    },
    {
      "id": "bob",
      "name": "Bob",
      "description": "Leave a trail of green creep that damages enemies",
      "requires": 3,
      "items": [
        "Bob's Brain",
        "Bob's Rotten Head",
        "Bob's Curse",
        "Ipecac",
        "Bob's Bladder (trinket)"
      ]
    },
    {
      "id": "spun",
      "name": "Spun",
      "description": "Damage up (+2) and speed up (+0.15), spawn a random pill",
      "requires": 3,
      "items": [
        "Adrenaline",
        "Euthanasia",
    ...
    },
    {
      "id": "yes-mother",
      "name": "Yes Mother?",
      "description": "Gain a stationary knife that trails behind you",
      "requires": 3,
      "items": [
    ...
    },
    {
      "id": "conjoined",
      "name": "Conjoined",
      "description": "Gain two extra faces that shoot diagonally. -0.3 damage, -0.3 tears",
      "requires": 3,
      "items": [
        "Abel",
        "Acid Baby",
    ...
    },
    {
      "id": "leviathan",
      "name": "Leviathan",
      "description": "Gain flight and 2 Black Hearts",
      "requires": 3,
      "items": [
        "Abaddon",
        "Brimstone",
    ...
    },
    {
      "id": "oh-crap",
      "name": "Oh Crap",
      "description": "Gain half a Red Heart every time poop is destroyed",
      "requires": 3,
      "items": [
        "Brown Nugget",
        "Butt Bombs",
    ...
    },
    {
      "id": "bookworm",
      "name": "Bookworm",
      "description": "25% chance to shoot an extra tear with each shot",
      "requires": 3,
      "items": [
        "Anarchist Cookbook",
        "The Bible",
    ...
    },
    {
      "id": "spider-baby",
      "name": "Spider Baby",
      "description": "Spawn a spider familiar that applies random status effects on contact",
      "requires": 3,
      "items": [
        "Box of Spiders",
        "Bursting Sack",
    ...
    },
    {
      "id": "adult",
      "name": "Adult",
      "description": "Gain 1 Red Heart container. Triggered by taking 3 Puberty pills",
      "requires": 3,
      "items": [
        "Puberty (pill, take 3 times)"
      ]
    },
    {
      "id": "stompy",
      "name": "Stompy",
      "description": "Destroy rocks by walking over them, leave dust clouds. Triggered by size-increasing effects",
      "requires": 3,
      "items": [
        "Leo",
        "Magic Mushroom",
        "One Makes You Larger (pill, each counts separately)"
      ]
    }
  ],
  "trinkets": [
